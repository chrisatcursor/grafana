      ...
      <Page.Contents>
        <Alert severity="info" title="">
          <Trans i18nKey="admin.feature-toggles.info-description">
            Feature toggles are evaluated via the OpenFeature SDK. Values reflect the current provider configuration
            (grafana.ini or remote provider). Changes typically require a server restart.
          </Trans>
        </Alert>
