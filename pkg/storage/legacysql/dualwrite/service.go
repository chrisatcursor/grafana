...
func ProvideService(
	...
	enabled := featuremgmt.OpenFeatureIsEnabledGlobally(features, featuremgmt.FlagManagedDualWriter) ||
		featuremgmt.OpenFeatureIsEnabledGlobally(features, featuremgmt.FlagProvisioning) // required for git provisioning
