...
type HTTPServer struct {
	...
	migrationAdminStatus            unifiedmigration.MigrationAdminStatusProvider
	tlsCerts                        TLSCerts
...
func ProvideHTTPServer(opts ServerOptions, cfg *setting.Cfg, routeRegister routing.RouteRegister, bus bus.Bus,
	...
	userVerifier user.Verifier, pluginPreinstall pluginchecker.Preinstall, migrationAdminStatus unifiedmigration.MigrationAdminStatusProvider,
) (*HTTPServer, error) {
	web.Env = cfg.Env
	m := web.New()
	...
	hs := &HTTPServer{
		...
		migrationAdminStatus:         migrationAdminStatus,
