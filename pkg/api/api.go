...
func (hs *HTTPServer) registerRoutes() {
	...
	r.Get("/admin/feature-flags", authorize(ac.EvalPermission(ac.ActionServerStatsRead)), hs.Index)
	...
	r.Group("/api/admin", func(adminRoute routing.RouteRegister) {
		...
		adminRoute.Get("/feature-toggles", authorize(ac.EvalPermission(ac.ActionServerStatsRead)), routing.Wrap(hs.AdminGetFeatureToggles))
