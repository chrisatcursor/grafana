...
func (a *api) shouldUseK8sAPIs() bool {
	return featuremgmt.OpenFeatureIsEnabledGlobally(a.features, featuremgmt.FlagKubernetesAuthZResourcePermissionsRedirect) &&
		featuremgmt.OpenFeatureIsEnabledGlobally(a.features, featuremgmt.FlagKubernetesAuthzResourcePermissionApis)
}
...
func (a *api) getPermissions(c *contextmodel.ReqContext) response.Response {
	...
	if featuremgmt.OpenFeatureIsEnabledGlobally(a.features, featuremgmt.FlagKubernetesAuthZResourcePermissionsRedirect) &&
		featuremgmt.OpenFeatureIsEnabledGlobally(a.features, featuremgmt.FlagKubernetesAuthzResourcePermissionApis) {
