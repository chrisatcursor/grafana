...
func ProvideAuthZClient(
	...
	zanzanaEnabled := openfeature.NewDefaultClient().Boolean(context.Background(), featuremgmt.FlagZanzana, false, openfeature.EvaluationContext{})
	...
	if !openfeature.NewDefaultClient().Boolean(context.Background(), featuremgmt.FlagAuthZGRPCServer, false, openfeature.EvaluationContext{}) && authCfg.mode == clientModeCloud {
		return nil, errors.New("authZGRPCServer feature toggle is required for cloud and grpc mode")
	}

	if zanzanaEnabled && openfeature.NewDefaultClient().Boolean(context.Background(), featuremgmt.FlagZanzanaNoLegacyClient, false, openfeature.EvaluationContext{}) {
...
func ProvideStandaloneAuthZClient(
	...
	if !openfeature.NewDefaultClient().Boolean(context.Background(), featuremgmt.FlagAuthZGRPCServer, false, openfeature.EvaluationContext{}) {
		return nil, nil
	}
